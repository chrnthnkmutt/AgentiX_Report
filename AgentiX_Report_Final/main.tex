...
\item \textbf{Tip Box:} A highlighted tip advises: ``Be specific with thresholds and roles. 'Finance Head approves PO \$\geq \$ 50\,000\; TRB\; CEO above' works better than 'large purchases need CEO'. The AI matches role names you use in the org chart.''
\end{itemize}
